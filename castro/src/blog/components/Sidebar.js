...
class Sidebar extends Component {
  render() {
    ...
    let categoryData = [
      { categoryLink: "blog-left-sidebar", categoryName: "Case Studies" },
      { categoryLink: "blog-left-sidebar", categoryName: "SEO & Marketing" },
      {
      ...
      {
        categoryLink: "blog-left-sidebar",
        categoryName: "Practice Management",
      },
      { categoryLink: "blog-left-sidebar", categoryName: "Industry Trends" },
      { categoryLink: "blog-left-sidebar", categoryName: "Patient Engagement" },
      { categoryLink: "blog-left-sidebar", categoryName: "Business Growth" },
    ];
    ...
    let popularPostData = [
      {
        ...
        postTitle: "What are Groundworkers and what do they do?",
